...
/**
 * User: Joseph Vartuli Date: 25/08/12
 * 
 * Simple Authentication Provider ensuring that the username and password is jack and jill. This is the place to put in
 * a more comprehensive data layer and security model.
 */
public class RestAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication)
        ...
        if (!key.equals("tomek") || !credentials.equals("tomek")) {

...
public class DbRunner {
    ...
    public Node addService(String name) {
        ...
        services.add(service, SERVICE_PROPERTY_NAME, service.getProperty(SERVICE_PROPERTY_NAME));
        return service;
    }
    ...
    public Node addNode(String name) {
        ...
        services.add(node, NODE_PROPERTY_NAME, node.getProperty(NODE_PROPERTY_NAME));
        return node;
    }

    public Node getNodeWithProperty(String propertyName, String value) {
        for (Node node : GlobalGraphOperations.at(grapDatabaseService).getAllNodes()) {
    ...
    public void createDatabase() {
        ...
        grapDatabaseService = new GraphDatabaseFactory().newEmbeddedDatabase(DB_PATH);
